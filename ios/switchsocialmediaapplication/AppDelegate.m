...
//                                                   moduleName:@"switchsocialmediaapplication"
...
- (RCTBridge *)initializeReactNativeApp
  {
    ...
    RCTRootView *rootView = [[RCTRootView alloc] initWithBridge:bridge moduleName:@"switchsocialmediaapplication" initialProperties:nil];
